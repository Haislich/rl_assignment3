...
#         "from", episodes=[dataset.episodes[idx] for idx in test_episodes.indices]
#     )
#     eval_set = RolloutDataset(
#         "from", episodes=[dataset.episodes[idx] for idx in eval_episodes.indices]
#     )
...
#         create_gif(
#             Episode.load(dataset.episodes[i]),
#             vision,
